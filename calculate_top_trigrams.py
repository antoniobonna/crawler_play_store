...
query_data = "SELECT DISTINCT mes,ano FROM google_play_dw.vw_reviews WHERE app_id = '{}' AND (mes,ano) != (date_part('month',current_date),date_part('year',current_date)) ORDER BY 2,1"
query_comentario = "SELECT comentario FROM google_play_dw.vw_reviews WHERE app_id = '{}' AND ano = {} AND mes = {}"
tablename = 'google_play_dw.trigrams'
